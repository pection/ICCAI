"""
Copied deprecated scipy code for imread and imrescale
https://github.com/scipy/scipy/blob/14142ff70d84a6ce74044a27919c850e893648f7/scipy/misc/pilutil.py
"""
...
if __name__ == "__main__":
    # Very quick and dirty check to kinda quickly make sure this thing workish
    import matplotlib.pyplot as plt

    img = imread("CLEVR_test_014998.png", mode="RGB")
    plt.imshow(img)
    plt.show()
    plt.close()

    img2 = imresize(img, (224, 224), interp="bicubic")
    plt.imshow(img2)
    plt.show()
    plt.close()
